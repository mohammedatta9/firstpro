...
<body >
  ...
  <h2 class="text-white"> المشاريع المقترحة</h2>
</nav>
  ...
  <thead>
    <tr>
      <th scope="col">#</th>
      <th scope="col">العنوان المشروع</th>
   ...
   <?php
            ...
            <tr>
                ...
                <td><?= $row['typ'] ?></td>
                 <td><?= $row['dp'] ?></td>
                 <td><form action="activea.php?n1=<?= $row['id'] ?>" method="post"> <button class="btn btn-primary" name="register" type="submit"> تثبيت</button>  </form> </td> 
