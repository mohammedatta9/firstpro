...
<body >
  ...
  <h2 class="text-white"> الطلاب المثبيتن</h2>
</nav>
  ...
  <thead>
   ...
   <?php
            ...
            <tr>
                ...
                <td><?= $row['lv'] ?></td>
                 <td><?= $row['phonn'] ?></td>
                  <td><form action="delst.php?n1=<?= $row['id'] ?>" method="post"> <button class="btn btn-primary" name="register" type="submit"> حذف</button>  </form></td>
